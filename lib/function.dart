main(){
  ...
  calculateArea_with_optional_parameter(0.5,0.5);
  calculateArea_with_optional_parameter(0.5,0.5,'Dhaka');
  calculateArea_with_optional_parameter(0.5,0.5,);
  calculateArea_with_optional_parameter(0.5,0.5,'Rangpur');
...
calculateArea_with_optional_parameter(double length, double width, [String ? des]){
